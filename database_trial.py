...
with open("C:\Users\Prathu\Desktop\Sem3 notes,assignments\Project\Database\excersise.csv", mode ='w',newline = '') as file:
...
with mp_pose.Pose(min_detection_confidence=0.5,min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            #log excersise data to the excel file

            if count > 0:
                with open ("C:\Users\Prathu\Desktop\Sem3 notes,assignments\Project\Database\excersise.csv",mode = 'a', newline = '') as file:
                    writer = csv.writer(file)
                    writer.writerow([time.strftime("%Y-%m-%d %H:%M:%S"),count, stage])
